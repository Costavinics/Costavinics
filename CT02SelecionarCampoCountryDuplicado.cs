...
{
    [TestFixture]
    public class CT02SelecionarCampoCountryDuplicado
    {
        ...
        [Test]
        public void TheCT02SelecionarCampoCountryDuplicadoTest()
        {
            ...
            driver.FindElement(By.XPath("//form[@id='basicBootstrapForm']/div[8]")).Click();
            ...
            new SelectElement(driver.FindElement(By.XPath("(//select[@type='text'])[4]"))).SelectByText("July");
